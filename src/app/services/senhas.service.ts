...
export class SenhasService {
  ...
  public senhasArray: SenhasArray = {SE:[], SG:[], SP:[]}
  ...
  novaSenha(tipoSenha:string = '') {
    ...
    if (tipoSenha == 'SG') {
      ...
      ' - ' + 
      tipoSenha + 
      (this.senhasArray['SG'].length + 1).toString().padStart(2, '0').toString().padStart(2,'0');
      ...
      ' - ' + 
      tipoSenha + 
      (this.senhasArray['SP'].length + 1).toString().padStart(2, '0').toString().padStart(2,'0');
      ...
      ' - ' + 
      tipoSenha + 
      (this.senhasArray['SE'].length + 1).toString().padStart(2, '0').toString().padStart(2,'0');
